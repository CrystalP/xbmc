...
DXGI_COLOR_SPACE_TYPE CProcessorHD::GetDXGIColorSpaceSource(DXGIColorSpaceArgs csArgs,
                                                            bool supportHDR,
                                                            bool supportHLG)
{
  // RGB
...
DXGI_COLOR_SPACE_TYPE CProcessorHD::GetDXGIColorSpaceTarget(DXGIColorSpaceArgs csArgs,
                                                            bool supportHDR)
{
