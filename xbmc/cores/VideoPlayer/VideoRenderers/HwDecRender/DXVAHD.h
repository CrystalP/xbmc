...
public:
 ...
 ~CProcessorHD();
  ...
  static DXGI_COLOR_SPACE_TYPE GetDXGIColorSpaceSource(DXGIColorSpaceArgs csArgs,
                                                       bool supportHDR,
                                                       bool supportHLG);
  static DXGI_COLOR_SPACE_TYPE GetDXGIColorSpaceTarget(DXGIColorSpaceArgs csArgs, bool supportHDR);
